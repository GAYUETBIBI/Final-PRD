...
### 20*20
* [带有口白的ppt](https://github.com/GAYUETBIBI/Final-PRD/blob/master/保持通话app.pptx)
...
### 二、加值宣言
本产品皆在通过使用百度AI的部分功能（语音识别、语音合成）使聋哑人以及听力衰退的老人也能像正常人用手机打电话，进行基本的社交活动。
...
### 三、原型文档
* [保持通话APP原型](http://yoga23.gitee.io/keep-calling)
* [保持通话APP原型下载](https://gitee.com/yoga23/keep-calling)
...
* 百度作为拥有着庞大适用人群以及数据，有着充足的材料去训练提高API的能力。
* 百度语音合成API，200字，56秒，语言表达清晰，断句正确，语调正常平稳，女声声音好听。
* 百度语音合成API语言表达清晰没有读错或读漏，正确率可达98%，此准确率可以满足本产品需求。
